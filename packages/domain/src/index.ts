...
export const SETTLEMENT_TRANSITIONS: TransitionMap<SettlementStatus> = {
  ...
  FUNDED: ["MILESTONE_PENDING", "FROZEN"],
  MILESTONE_PENDING: ["MILESTONE_VERIFIED", "DISPUTED", "FROZEN"],
  MILESTONE_VERIFIED: ["AWAITING_RELEASE_APPROVAL", "DISPUTED"],
  AWAITING_RELEASE_APPROVAL: ["RELEASE_PENDING", "DISPUTED"],
  RELEASE_PENDING: ["PARTIALLY_SETTLED", "SETTLED", "DISPUTED"],
  PARTIALLY_SETTLED: ["MILESTONE_PENDING", "SETTLED", "DISPUTED"],
  DISPUTED: ["FROZEN", "PARTIALLY_SETTLED", "SETTLED"],
  FROZEN: ["DISPUTED", "SETTLED"],
  SETTLED: [],
};
